    ...
    <div className="page-container" data-testid="catalog-page">
      ...
      <div className="pt-28 pb-20 max-w-7xl mx-auto px-6 md:px-12">
        ...
        >
          ...
          <h1
            className="font-heading text-4xl md:text-5xl font-black tracking-tighter mb-6"
    ...
    "
      ...
      "
        ...
        {loading ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[1, 2, 3, 4, 5, 6].map((i) => (
              <div key={i} className="car-card animate-pulse h-[400px]" />
            ))}
          </div>
        ) : filtered.length === 0 ? (
          <div
                ...
                >
                  ...
                  >
                    <div className="relative overflow-hidden h-52">
                      ...
                      <div className="absolute top-3 left-3 flex gap-2">
                        {car.is_from_europe && (
                          <span className="bg-brand-gold text-black px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider">
                            Европа
                          </span>
                        )}
                        {car.is_commission && (
                          <span className="bg-brand-blue text-white px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider">
                            Комиссия
                          </span>
                        )}
                      </div>
                    ...
                    <div className="p-5">
                      <div className="flex items-start justify-between mb-2">
                        ...
                        <div className="text-right whitespace-nowrap">
                          <div className="font-heading text-lg font-black text-brand-gold">
